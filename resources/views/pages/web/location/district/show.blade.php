    ...
    <div class="mx-auto max-w-screen-xl p-2">
        <div class="breadcrumbs text-sm">
            <ul>
                ...
                <li><a href="{{ App\Services\LocationService::getUrlForCity($location->city, route('web.location.city.show', ['country' => $location->country->country, 'city' => $location->city->city])) }}">{{ __('location.' . $location->city->city) }}</a></li>
