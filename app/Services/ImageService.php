...
class ImageService
{
    public static function getOptimizedImage(Image $image, $size, $sizes)
    {
        ...
        try {
            ...
            $optimized_image = SpatieImage::load($image->path())->height($size)->width($size)->format('webp')->save($path);
        } catch (Exception $e) {
            Log::error($e);
        }
    ...
    public static function getOptimizedImageWH(Image $image, $size, $sizes)
    {
        ...
        try {
            ...
            $optimized_image = SpatieImage::load($image->path())->fit(Fit::Max, $width, $height)->format('webp')->save($path);
        } catch (Exception $e) {
            Log::error($e);
        }
