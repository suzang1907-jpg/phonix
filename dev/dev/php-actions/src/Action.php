...
abstract class Action
{
    ...
    /** Called on done */
    public function done(Response $response)
    {
        return $response;
    }
    ...
    public function _getConverted(mixed $converter_class): mixed
    {
        ...
        return Run::converter($converter_class, $converter_data);
    }
    ...
    public function validate()
    {
        foreach ($this->validator as $key => $value) {
            ...
            $result = Run::validator($value, $data);
    ...
    public static function parse_action_done_response($action, $response)
    {
        if (empty($response)) {
            $response = Response::done($action, $response);
        } else {
