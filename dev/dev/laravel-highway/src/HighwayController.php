...
abstract class HighwayController extends Controller
{
    ...
    protected static string $view_namespace = '';
    ...
    public function _action(string $type, string | null $namespace = null, string | null $contextName): Response | null
    {
        ...
        $response = Action::build($action_class)->data(Traffic::get())->run();
    ...
    public function _responseAction(string $type, array | null $data = [], string | null $namespace = null, string | null $contextName = null): Response | null
    {
    ...
    public function view(string $entity, string $type, string $namespace, string $routeName, string $contextName)
    {
        ...
        $route_class = $namespace . '\\Routing\\' . $contextName;

        if (! empty(static::$view_namespace)) {
            return $route_class::view(static::$view_namespace . '::pages.' . $routeName, $this->_getAttachedData());
        }
