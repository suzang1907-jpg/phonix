...
namespace Dev\LaravelAssets\Providers;
...
class LaravelAssetsProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        ], 'dev/laravel-assets/migrations-images');
        ...
        ], 'dev/laravel-assets/migrations-files');
        ...
        ], 'dev/laravel-assets/migrations-markdowns');
        ...
        ], 'dev/laravel-assets/migrations-pdfs');
    }
}
